...
public class RESTCaller {
	...
	private class RestCallerAsyncTaskJsonObject extends
	...
	private class RestCallerAsyncTaskJsonArray extends
	...
	public static String loginCall(Website website, String username) {
		switch (website) {
		case FACEBOOK:
			return "login/facebook/" + username;
		case TWITTER:
			return "login/twitter/" + username;
		default:
			return "";
	...
	public String loginCall(Website website, String macAddress,
			String username, String password) {
		switch (website) {
		case FACEBOOK:
			return "login/" + macAddress + "/facebook/" + username;
		case TWITTER:
			return "login/" + macAddress + "/twitter/" + macAddress + username;
		case SOCPROX:
			return "login/" + macAddress + "/socprox/" + username + "/"
					+ password;
		default:
			return "";
	...
	public static String registerCall(String macAddress, String username,
			String password) {

		return "register/" + macAddress + "/" + username + "/" + password;
	}

	public static String registerAliasCall(Website website, String username,
			String socproxUsername) {
		switch (website) {
		case FACEBOOK:
			return "registerAlias/facebook/" + username + "/" + socproxUsername;
		case TWITTER:
			return "registerAlias/twitter/" + username + "/" + socproxUsername;
		case SOCPROX:
			return "registerAlias/soxprox/" + username + "/" + socproxUsername;
		default:
			return "";
		}
	}

	public static String updateProfile(String socproxUsername,
